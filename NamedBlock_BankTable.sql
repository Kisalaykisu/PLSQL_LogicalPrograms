...
insert into bankaccount values('Kisalay',8080642768);
...
EXECUTE InsertBankData('kia singh', 67632223);
...
EXECUTE UpdateBankData('Kane', 773422654);

SELECT * FROM bankaccount;

SELECT * FROM bankaccount where customerName='Kane';
